...
public class GCM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String masterKey1 = "fcxdeswswaqwQ";
        String masterKey2 = "4rdcgfccft;iughyugtdes";
        String masterKey3 = "!@#$%^*&(*&((^%######SXredxt5r4xs#$@#WXCFUV*^RFD";
        String my_string = myObj.nextLine();
        String encryptedData = encrypt(masterKey1, my_string);
        System.out.println("Encrypted 1: " + encryptedData);
        String decryptedText = decrypt(encryptedData, masterKey1);
        System.out.println("Decrypted 1: " + decryptedText);
        String encryptedData2 = encrypt(masterKey2, my_string);
        System.out.println("Encrypted 2: " + encryptedData2);
        String decryptedText2 = decrypt(encryptedData2, masterKey2);
        System.out.println("Decrypted 2: " + decryptedText2);
        String encryptedData3 = encrypt(masterKey3, my_string);
        System.out.println("Encrypted 2: " + encryptedData3);
        String decryptedText3 = decrypt(encryptedData3, masterKey3);
        System.out.println("Decrypted 2: " + decryptedText3);
    }
